...
<div class="mo_ldap_local_licensing_main_body">
	...
	<div id="mo_ldap_local_pricing_div" class="mo_ldap_local_licensing_body">
		...
		<div id="mo_ldap_local_plans">
			<div id="mo_ldap_single_site_plans" class="mo_ldap_local_licensing_all_plans <?php echo strcasecmp( $site_type, 'multisite' ) === 0 ? 'mo_ldap_d_none' : ''; ?>">
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container1">
					<div class="mo_ldap_local_licensing_plan_name">
						<div class="mo_ldap_local_each_plan_heading">
							Essential Authentication Plan
						</div>
						<br><br>
						<script>
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							...
							<div style="width: 80%;">Full Featured Premium LDAP Plugin</div>
						</div>

						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;"><b>Free Plugin Updates for 1 year</b></div>
						</div>
					</div>

					<button class="mo_ldap_next_btn mo_ldap_local_licensing_buy_now_btn" onclick="upgradeform('wp_ldap_intranet_premium_plan')">
						Buy Now
					</button>
				</div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container2">
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Everything from the Essential Authentication plan</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Kerberos / NTLM SSO add-on</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;"><b>Free Plugin Updates for 1 year</b></div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container3">
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Everything from the Kerberos/NTLM SSO plan</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Sync Users LDAP Directory Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Password Sync with LDAP Server Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Profile Picture Sync Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">WP Groups Plugin Integration</div>
						</div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container4">
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div style="width: 80%;">Everything from the Advanced Authentication & Syncing Plan</div>
						</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;">Page/Post Restriction Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;">WP-CLI Integration Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;">Search Staff from LDAP Directory Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;">BuddyPress Profile Integration</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;">All Third Party App Integrations</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div style="width: 80%;"><b>Free Plugin Updates for 1 year</b></div>
			...
			<div id="mo_ldap_multi_site_plans" class="mo_ldap_local_licensing_all_plans <?php echo strcasecmp( $site_type, 'multisite' ) !== 0 ? 'mo_ldap_d_none' : ''; ?>" >
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container1">
					<div class="mo_ldap_local_licensing_plan_name">
						<div class="mo_ldap_local_each_plan_heading">
							Multisite Essential Authentication Plan
						</div>
						<br><br>
						<script>
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Full Featured Premium LDAP Plugin</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div><b>Free Plugin Updates for 1 year</b></div>
						</div>
					</div>

					<button class="mo_ldap_next_btn mo_ldap_local_licensing_buy_now_btn" onclick="upgradeform('wp_ldap_intranet_multisite_premium_plan')">
						Buy Now
					</button>
				</div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container2">
					<div class="mo_ldap_local_licensing_plan_name">
						<div class="mo_ldap_local_each_plan_heading">
							Multisite Kerberos/NTLM SSO Plan 
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Everything from the Essential Authentication plan</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Kerberos / NTLM SSO add-on</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div><b>Free Plugin Updates for 1 year</b></div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container3">
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Everything from the Kerberos/NTLM SSO plan</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Sync Users LDAP Directory Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Password Sync with LDAP Server Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Profile Picture Sync Add-On</div>
						</div>
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>WP Groups Plugin Integration</div>
						</div>
				...
				<div class="mo_ldap_local_licensing_plan_container mo_ldap_local_licensing_plan_container4">
					...
					<div class="mo_ldap_local_licensing_details_about_plan">
						<div>
							<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
							<div>Everything from the Advanced Authentication & Syncing Plan</div>
						</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div>Page/Post Restriction Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div>WP-CLI Integration Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div>Search Staff from LDAP Directory Add-On</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div>BuddyPress Profile Integration</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div>All Third Party App Integrations</div>
					</div>
					<div>
						<span class="mo_ldap_local_licensing_bullets"><img src="<?php echo esc_url( MO_LDAP_LOCAL_IMAGES . 'tick.svg' ); ?>" height="12px" width="12px"></span>
						<div><b>Free Plugin Updates for 1 year</b></div>
	...
	<div id="mo_ldap_local_feature_comparison" class="mo_ldap_local_licensing_feature_comparison">
		...
		<div class="mo_ldap_local_licensing_feature_comparison_table">
			<div class="mo_ldap_local_licensing_feature_comparison_table_header">
				...
				<div class="mo_ldap_local_licensing_feature_comparison_col2"><b>Essential Authentication Plan</b></div>
				<div class="mo_ldap_local_licensing_feature_comparison_col2"><b>Kerberos / NTLM SSO Plan</b></div>
	...
	<div class="mo_ldap_local_more_details_link"><a href="https://plugins.miniorange.com/wordpress-ldap-login-intranet-sites#PlanComparison" target="_blank">View Detailed Comparision</a></div>
				...
				<div id="mo_ldap_local_premium_add_ons" class="mo_ldap_local_all_addons">
					<?php foreach ( $addon_array_recommended as $addon ) { ?>
						<div class="mo_ldap_local_each_addon mo_ldap_local_each_addon_licensing_page ">
							...
							<p class="mo_ldap_local_addons_para">
								<b style="font-size:25px">$<?php echo esc_html( $addon['addonPrice'] ); ?></b>/Instance
							</p>
...
<div style="right: 33%;" id="mo_ldap_local_contact_us_box" class="mo_ldap_local_popup_box mo_ldap_local_contact_us_popup mo_ldap_d_none">
		...
		<div>
			<form name="mo_ldap_local_contact_us_form" method="post" action="">
				...
				<div class="mo_ldap_local_horizontal_flex_container">
					...
					<button href="" type="button" class="mo_ldap_cancel_button" data-id="mo_ldap_local_contact_us_box" onclick="mo_ldap_local_popup_card_cancel_remove(this)">Cancel</button>
				</div>
			</form>
		</div>
	</div>
