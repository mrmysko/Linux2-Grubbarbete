...
?>
<div class="mo_ldap_login_settings_outer mo_ldap_local_outer mo_ldap_outer_box">
	...
	<div class="mo_ldap_local_outer_attr_mapping">
		...
		<form name="enable_login_form" id="enable_login_form" method="post" action="">
			...
			<div>
				...
				<label for="enable_ldap_login" class="mo_ldap_local_d_inline">
					Enable Login Using LDAP
				</label>	
			</div>
			<div class="mo_ldap_test_authentication_heading" style="width:70%; margin-left:2%;">
				Enabling LDAP login will protect your login page by your configured LDAP.<br><br>
		...
		<form name="enable_admin_wp_login" id="enable_admin_wp_login" method="post" action="">
			...
			<div>
				...
				if ( strcasecmp( $enable_ldap_login, '1' ) === 0 ) {
					?>
					...
					<label for="mo_ldap_local_enable_admin_wp_login" class="mo_ldap_local_d_inline">
		...
		<form name="enable_register_user_form" id="enable_register_user_form" method="post" action="">
			...
			<div>
				...
				<label for="mo_ldap_local_register_user" class="mo_ldap_local_d_inline">
	...
	<div class="mo_ldap_local_outer_login_settings mo_ldap_local_premium_box">
		<div style="right:5%;" class="mo_ldap_local_premium_role_mapping_banner mo_ldap_d_none mo_ldap_local_login_settings_premium">
