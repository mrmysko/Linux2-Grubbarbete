	...
	<div class="mo_ldap_local_outer mo_ldap_local_premium_box">
		...
		<div class="mo_ldap_local_premium_feature_box">
			...
			<div class="mo_ldap_local_multiple_directories_each_div">
				<div>LDAP Server*</div>
				<div><input type="text" id="phone_attribute" name="phone_attribute" placeholder="Enter Phone Attribute" class="mo_ldap_local_disabled_input_field mo_ldap_local_disabled_input_field_md" disabled></div>
