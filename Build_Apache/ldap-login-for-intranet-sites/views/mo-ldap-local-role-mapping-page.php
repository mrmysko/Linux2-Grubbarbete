...
<div class=" mo_ldap_outer_box" >
	...
	<div class="mo_ldap_role_local_outer">
		<h2>Default Role Mapping Configuration</h2>
		<hr>
		<br>
		<form name="enable_role_mapping_form" id="enable_role_mapping_form" action="" method="post">
			...
			<div class="mo_ldap_local_input_field_container">
				<label for="default_group_mapping" class="mo_ldap_local_d_block mo_ldap_local_bold_label">Select the default WordPress role all users will have:</label>
				<select id="default_group_mapping" name="mapping_value_default" class="mo_ldap_local_standerd_input mo_ldap_select_directory_server">
					<?php
			...
			<div class="mo_ldap_local_input_container mo_ldap_local_horizontal_flex_container mo_ldap_local_content_start">
				...
				<label for="enable_ldap_role_mapping" class="mo_ldap_local_d_inline mo_ldap_local_bold_label">
					Enable Role Mapping
				</label>
			</div>
			<div class="mo_ldap_local_input_container mo_ldap_local_horizontal_flex_container mo_ldap_local_content_start">
				...
				<label for="keep_existing_user_roles" class="mo_ldap_local_d_inline mo_ldap_local_bold_label">
	...
	<div class="mo_ldap_local_outer">
		<div class="mo_ldap_local_test_role_mapping_inner" style="margin:2%;">
			...
			<form method="post" id="rolemapconfigtest">
				...
				<label for="mo_ldap_username">Username</label>
				<br>
				<input type="text" id="mo_ldap_username" name="mo_ldap_username" class="mo_ldap_local_input" placeholder="Enter Username" style="width:50%;" required>
				<br>
				<p style="font-size:12px;">Enter LDAP username to test role mapping configuration</p>
				<?php
				...
				?>
				<div class="mo_ldap_local_horizontal_flex_container mo_ldap_local_content_start mo_ldap_local_flex_gap">
